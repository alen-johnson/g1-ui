    ...
    <div className="result">
      <div class="cards">
        <div class="outlinePage">
          ...
          <p class="userName">{sortedScores[0][0]}</p>
        </div>
        <div class="detailPage">
          ...
          <div class="gradesBox">
            ...
            <p class="gradesBoxNum">{sortedScores[0][1]}</p>
          </div>
        </div>
      </div>
      <div class="cards">
        <div class="outlinePage2">
          <svg
            class="icon trophy"
            viewBox="0 0 1024 1024"
            version="1.1"
          ...
          <p class="ranking_number2">
            2<span class="ranking_word">nd</span>
          </p>
          ...
          <p class="userName">{sortedScores[1][0]}</p>
        </div>
        <div class="detailPage">
          <svg
            class="icon medals slide-in-top"
          ...
          <div class="gradesBox">
            ...
            <p class="gradesBoxLabel">SCORE</p>
            <p class="gradesBoxNum">{sortedScores[1][1]}</p>
          </div>
        </div>
      </div>
    </div>
